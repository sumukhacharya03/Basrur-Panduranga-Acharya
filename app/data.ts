...
export const PROJECTS_DEVANAGARI: Project[] = [
  {
    ...
    subtitle:
      '(Methods of Offering Various Holy Objects into the sacrificial Fire)',
    description:
      'This book was published during 2016 and it contains a collection of variety of Poojas, Havanas, Vritas etc written for the benefit of ‘Purohits’ covering all the extensive information that they would need in a single book.',
  ...
  },
  {
    ...
    description:
      'This book was published during 2018 and it contains a collection of step-by-step rituals performed on one of the main Hindu deities, Mahavishnu.',
  ...
  },
  {
    ...
    description:
      'This book was published during 2019 and it contains recitation and uttering of short vedas and shastras to please the Hindu Gods. In addition to this, it elaborates on music and dance, Conch/Shankh blowing, spiritual entertainment and rituals of serving as different ways to offer devotion.',
  ...
  },
  {
    ...
    description:
      'This book was published during 2021 and it talks about the importance of showing respect to the deceased through funeral ceremonies as well as annual rights & observations. He writes about how performing a Dharmic Funeral or holding a celebration of life in memory of the deceased remains the duty of their children.',
...
export const MENU_LINKS: MenuLink[] = [
  {
    name: 'Career as a Teacher',
    href: '/accomplishments/career-as-a-teacher',
    id: 'acc1',
  },
  {
  ...
  },
  {
    ...
    href: '/accomplishments/other-activities',
    id: 'acc3',
  },
